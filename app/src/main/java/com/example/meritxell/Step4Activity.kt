...
class Step4Activity : AppCompatActivity() {
    ...
    private var currentStepNumber: Int = 4 // This activity is for Step 4
    private val documentId: String = "document_11_acknowledgment_proof" // Unique ID for this document in Firestore
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uploadButton = findViewById(R.id.uploadDocumentBtn11)
        statusTextView = findViewById(R.id.submissionStatusTextView11)
        attemptsTextView = findViewById(R.id.attemptsRemainingTextView11)
        checkImageView = findViewById(R.id.submittedCheckImageView11)
    ...
    private fun setupAdminCommentListener() {
        ...
        val userId = user.uid
        val stepKey = "step${currentStepNumber}" // This will be "step4" for this activity
    ...
    private fun updateUIBasedOnSubmissionStatus() {
        ...
        db.collection("user_submissions_status") // Correct collection name
            .document(userId)
            .collection("step${currentStepNumber}_documents") // e.g., "step4_documents"
            .document(documentId)
            .get()
                ...
                uploadTask.addOnSuccessListener { taskSnapshot ->
                    ...
                    storageRef.downloadUrl.addOnSuccessListener { downloadUri ->
                        ...
                        val documentData = hashMapOf(
                            ...
                            "status" to "pending_review" // Initial status set here
                        )
                        ...
                        db.collection("adoption_progress")
                            ...
                            .document(documentId) // This is the specific document within the subcollection (document_11_acknowledgment_proof)
