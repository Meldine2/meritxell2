...
class Step7Activity : AppCompatActivity() {
    ...
    private var currentStepNumber: Int = 7 // This activity is for Step 7
    private val documentId: String = "document_14_certificate_of_finality" // Unique ID for this document in Firestore
    ...
    private fun setupAdminCommentListener() {
        ...
        val userId = user.uid
        val stepKey = "step${currentStepNumber}" // This will be "step7" for this activity
    ...
    private fun updateUIBasedOnSubmissionStatus() {
        ...
        db.collection("user_submissions_status") // Correct collection name
            .document(userId)
            .collection("step${currentStepNumber}_documents") // e.g., "step7_documents"
            .document(documentId)
            .get()
                ...
                uploadTask.addOnSuccessListener { taskSnapshot ->
                    ...
                    storageRef.downloadUrl.addOnSuccessListener { downloadUri ->
                        ...
                        db.collection("adoption_progress")
                            ...
                            .document(documentId) // This is the specific document within the subcollection (document_14_certificate_of_finality)
