...
class Step5Activity : AppCompatActivity() {
    ...
    // UI elements for the single document upload
    private lateinit var uploadButton: Button
    private lateinit var statusTextView: TextView
    private lateinit var attemptsTextView: TextView
    private lateinit var checkImageView: ImageView
    private lateinit var formLinkTextView: TextView // New element for the link
    ...
    private var currentStepNumber: Int = 5 // This activity is for Step 5
    private val documentId: String = "document_12_personality_test_result" // Unique ID for this document in Firestore

    // URL for the personality test
    private val PERSONALITY_TEST_URL = "https://www.16personalities.com/free-personality-test"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize UI elements for the single document upload
        uploadButton = findViewById(R.id.uploadDocumentBtn12)
        statusTextView = findViewById(R.id.submissionStatusTextView12)
        attemptsTextView = findViewById(R.id.attemptsRemainingTextView12)
        checkImageView = findViewById(R.id.submittedCheckImageView12)
        formLinkTextView = findViewById(R.id.formLinkTextView) // Initialize the link TextView
        ...
        formLinkTextView.setOnClickListener {
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse(PERSONALITY_TEST_URL))
            try {
                startActivity(browserIntent)
                Log.d("Step${currentStepNumber}Activity", "Opening personality test link: $PERSONALITY_TEST_URL")
            } catch (e: Exception) {
                Toast.makeText(this, "Could not open link. Please check your browser.", Toast.LENGTH_LONG).show()
                Log.e("Step${currentStepNumber}Activity", "Failed to open link: ${e.message}", e)
            }
        }
        formLinkTextView.movementMethod = LinkMovementMethod.getInstance()
    ...
    private fun setupAdminCommentListener() {
        ...
        val userId = user.uid
        val stepKey = "step${currentStepNumber}" // This will be "step5" for this activity
    ...
    private fun updateUIBasedOnSubmissionStatus() {
        ...
        db.collection("user_submissions_status") // Correct collection name
            .document(userId)
            .collection("step${currentStepNumber}_documents") // e.g., "step5_documents"
            .document(documentId)
            .get()
                ...
                uploadTask.addOnSuccessListener { taskSnapshot ->
                    ...
                    storageRef.downloadUrl.addOnSuccessListener { downloadUri ->
                        ...
                        db.collection("adoption_progress")
                            ...
                            .document(documentId) // This is the specific document within the subcollection (document_12_personality_test_result)
